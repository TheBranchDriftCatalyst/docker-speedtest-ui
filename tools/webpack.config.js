...
const config = {
  ...
  module: {
    ...
    rules: [
      ...
      {
        test: reScript,
        include: [SRC_DIR, resolvePath('tools'), './ecosystem.config.js'],
        loader: 'babel-loader',
        options: {
          ...
          presets: [
            ...
            // TODO: Fix this ... its not correct since upgrade
      ...
      // Rules for Style Sheets
      {
        ...
        rules: [
          ...
          // Install dependencies before uncommenting: npm add --dev sass-loader node-sass
          {
            test: /\.(scss|sass)$/,
            loader: 'sass-loader'
          }
